...
const variantClasses = {
  ...
  success:
    "bg-blue-50 text-blue-900 border border-blue-200 dark:bg-[#162340] dark:text-blue-300 dark:border-[#3B82F6]/30",
  warning:
    "bg-yellow-100 text-yellow-800 border border-yellow-300 dark:bg-yellow-900/30 dark:text-yellow-400 dark:border-yellow-600",
  info:
    "bg-blue-50 text-blue-800 border border-blue-200 dark:bg-[#162340] dark:text-blue-300 dark:border-[#3B82F6]/30",
};
